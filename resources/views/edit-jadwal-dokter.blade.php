        ...
        <div class="col-12">
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Jadwal Periksa Dokter</h3>
                </div>
                <!-- form start -->
                <form action="{{route('editdokter.update',$poli->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="id_dokter" name="id_dokter" value="{{old('id_dokter',$dokters->user->nama)}}" readonly>
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="col-12 ml-4">
                            ...
                            <a href="/jadwal_periksa" class="btn btn-info">
                                Kembali
                            </a>
                        </div>
                    </div>
